...
models.PosModel = models.PosModel.extend({
    ...
    get_footer: function(){
        ...
        for (let i = 0; i < order_lines.length; i++) {
            ...
            vat_taxes_amount += line.get_tax();
        }
        var taxes_vals = {
            'vat_taxes_amount' : vat_taxes_amount.toFixed(2).toString(),
            'other_taxes_amount' : other_taxes_amount.toFixed(2).toString(),
        };
        items.push(taxes_vals);
        return items;
    },
