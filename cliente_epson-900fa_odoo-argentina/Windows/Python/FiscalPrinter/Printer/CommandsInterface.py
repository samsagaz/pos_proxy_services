...
def ImprimirItem(Handle):
    ...
    res = Handle.ImprimirItem(
        HighNivel.ID_MODIFICADOR_AGREGAR, "Pizza", "10.000", "0.3000",
...
def CargarDescuento(Handle, vals=None):
    res = Handle.CargarAjuste(
        HighNivel.ID_MODIFICADOR_DESCUENTO,
        "Descuento global",
        "10.00",
        c_int(0).value,
...
def CargarAjuste(Handle, vals=None):
    res = Handle.CargarAjuste(
        HighNivel.ID_MODIFICADOR_AJUSTE,
        "Ajuste Global",
        "20.00",
        c_int(0).value,
        "CodigoInterno4567890123456789012345678901234567890")
