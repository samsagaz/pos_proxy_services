...
def json_to_printer(vals):
    try:
        ...
        if type == 83:
            ...
            if not "cliente" in vals:
                raise Exception(
                    "En los Tique tipo factura es obligatorio el cliente"
                )
            values["cliente"] = obj_lowNivel.client_to_low_nivel(vals["cliente"]
            )
...
def test():
    ...
    jsonTemplate = {
        ...
        "items": [
            ...
            {
                "description": "bMouse Optico Logitech",
                "description_extra1": "Af56",
                "qty": 1,
                "price": 0.03,
                "iva": 21,
